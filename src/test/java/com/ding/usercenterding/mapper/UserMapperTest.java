...
class UserMapperTest {
    ...
    void testUserRegister(){
        ...
        String planeCode = "38756" ;
        Long res = userService.userRegister(userAccount, userPassword, checkPassword,planeCode);
        Assertions.assertEquals(-1,res);
        userAccount ="di";
        userPassword ="1234";
        res = userService.userRegister(userAccount, userPassword, checkPassword,planeCode);
        Assertions.assertEquals(-1,res);
